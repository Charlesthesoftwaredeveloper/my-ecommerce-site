          ...
          <div className="w-3/5 p-4 pb-25 flex items-center justify-center relative  overflow-hidden rounded-lg" style={{ height: '100%' }}>
            {slides.map((slide, index) => (
              <div
                ...
                } transition duration-500 ease-in-out w-full h-full`}
              >
                <img
                  src={slide.image}
                  alt={slide.alt}
...
{/* Second Row of Featured Categories */}
<section className="w-full bg-white py-6">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
      <div className="text-center">
        <img
          src="/special_offers.png" // Replace with actual image path
          alt="Special Offers"
          className="w-full h-auto rounded-lg"
        />
      ...
      <div className="text-center">
        <img
          src="/electronics_deals.png" // Replace with actual image path
      ...
      <div className="text-center">
        <img
          src="/mobile_accesories.png" // Replace with actual image path
      ...
      <div className="text-center">
        <img
          src="/starting_from_65.jpg" // Replace with actual image path
      ...
      <div className="text-center">
        <img
          src="/beauty_deals.png" // Replace with actual image path
          alt="Beauty Deals"
          className="w-full h-auto rounded-lg"
        />
      ...
      <div className="text-center">
        <img
          src="/home_essentials.png" // Replace with actual image path
          alt="Home Essentials"
          className="w-full h-auto rounded-lg"
        />
